...
- Stateless services: ECS, Azure Container Apps, Render, or similar container platforms.
...
- Docker Compose is the local development runtime, not production infrastructure.
...
- TODO Future: Add ECS or Azure Container Apps deployment examples.
